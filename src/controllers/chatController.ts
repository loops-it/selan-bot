...
export const chatResponse = async (req: RequestWithChatId, res: Response) => {
    ...
    const namespace = index.namespace('seylan-data')
    //seylan-data
...
// const fileIds  = await File.findAll({
            ...
            // const fetchResult = await index.namespace('seylan-data').fetch(ids);
